...
- [x] **Phase 34: security-portal Dev Path Restructure** — Same as Phase 33 for security-portal. Rebase or delete the dormant `dev` branch (20 commits behind main). Claim `portal-dev.triarchsecurity.com`. Wire CL-4 gate. (completed 2026-05-16)
