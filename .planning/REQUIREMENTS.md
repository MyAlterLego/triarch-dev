...
- [ ] **WORKFLOW-02**: `shared-workflows/deploy-prod.yml` POSTs prod deploy completion to admin's `/api/releases/promoted` with version, commit_sha, deployed_at, deployed_by (carried from v1.14 deferral)
